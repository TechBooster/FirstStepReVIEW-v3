...
もし間に合わなくても筆者と本書はのことは悪く思わないでください。ベストをつくしましょうね！
...
: オンデマンド印刷
  ～200部の小ロット印刷に適しています。印刷に使う版を作らないので手軽な一方、単価は高めです

: オフセット印刷
  200部〜の印刷に適しています。版を作る手法で、ロット数に応じて単価が安くなります
...
//image[epub][iBooksでの表示例][scale=0.75]{
