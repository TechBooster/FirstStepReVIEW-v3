...
レビューでは紙面レイアウトも含めてみることで素早く問題点に気づき、筆者にフィードバックを返せます。

実際の所、CIサーバの構築は手間がかかるのでTechBoosterで運用しているGrifletを公開したいのですが、
いまのところ負荷問題があり、至っていません。手軽に得られるビルド環境としてDockerファイルを提供しています。
...
だれもが最初から熟練者ではありません。初めての相談も快く受け入れてくれます。
 ...
 * 図、表、コードの登場前に本文中からそれぞれ参照を行う（＠<img>,＠<list>など）
 * 登場前に内容を簡単に説明する一文を書く
 * 登場後に詳しい解説を書く

これらを守ることで何について述べているのかわかりやすくなり、読者が読んだときの唐突感や投げっぱなし感がなくなります。

装飾については、これまでの同人活動を通じて使わないほうがよい、と感じてます。
装飾には、いわゆる太字、斜体などフォントの見た目を変えて読みやすくする意図があります。
しかし、利用基準を定めて守るほうがよっぽど難しく、一貫性を保つのが作業量的にしんどい側面
もあります。大事な内容であれば、文章中で注意喚起したほうがよっぽど良いでしょう。
